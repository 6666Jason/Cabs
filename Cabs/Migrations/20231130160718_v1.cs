        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Payments_Bookings_BookingFkId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Images_Companies_CompanyFkId",
                        column: x => x.CompanyFkId,
                        principalTable: "Companies",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AdvertiseImages", x => new { x.ImageId, x.AdvertiseId });
                    table.ForeignKey(
                        name: "FK_AdvertiseImages_Advertises_AdvertiseId",
                        column: x => x.AdvertiseId,
                        principalTable: "Advertises",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AdvertiseImages_Images_ImageId",
                        column: x => x.ImageId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Images_CompanyFkId",
                table: "Images",
                column: "CompanyFkId");

            migrationBuilder.CreateIndex(
                name: "IX_Images_DriverFkId",
                table: "Images",
                column: "DriverFkId");
